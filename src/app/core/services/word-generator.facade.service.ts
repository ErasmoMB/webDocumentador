...
export class WordGeneratorService {
  ...
  private docxDepsPromise?: Promise<{
    ...
    DocxDocumentFactory: typeof import('./word-generator/docx-document-factory').DocxDocumentFactory;
    DocxHtmlContentBuilder: typeof import('./word-generator/docx-html-content-builder').DocxHtmlContentBuilder;
    DocxImageBuilder: typeof import('./word-generator/docx-image-builder').DocxImageBuilder;
    DocxTableBuilder: typeof import('./word-generator/docx-table-builder').DocxTableBuilder;
  }>;
    ...
    if (!this.docxDepsPromise) {
      this.docxDepsPromise = (async () => {
        const [{ Packer }, fileSaver, docFactory, htmlBuilder, imageBuilder, tableBuilder] = await Promise.all([
          import('docx'),
          import('file-saver'),
          import('./word-generator/docx-document-factory'),
          import('./word-generator/docx-html-content-builder'),
          import('./word-generator/docx-image-builder'),
          import('./word-generator/docx-table-builder'),
        ]);
