...
import { Seccion6FormWrapperComponent } from 'src/app/shared/components/forms/seccion6-form-wrapper.component';
...
import { Seccion28ViewComponent } from 'src/app/shared/components/seccion28/seccion28-view.component';
import { Seccion28FormWrapperComponent } from 'src/app/shared/components/forms/seccion28-form-wrapper.component';
import { Seccion29ViewComponent } from 'src/app/shared/components/seccion29/seccion29-view.component';
import { Seccion29FormWrapperComponent } from 'src/app/shared/components/forms/seccion29-form-wrapper.component';
import { Seccion30ViewComponent } from 'src/app/shared/components/seccion30/seccion30-view.component';
import { Seccion30FormWrapperComponent } from 'src/app/shared/components/forms/seccion30-form-wrapper.component';
...
import { Seccion4FormComponent } from 'src/app/shared/components/seccion4/seccion4-form.component';
import { Seccion4ViewComponent } from 'src/app/shared/components/seccion4/seccion4-view.component';
import { Seccion4FormWrapperComponent } from 'src/app/shared/components/forms/seccion4-form-wrapper.component';
import { Seccion5FormComponent } from 'src/app/shared/components/seccion5/seccion5-form.component';
import { Seccion5ViewComponent } from 'src/app/shared/components/seccion5/seccion5-view.component';
import { Seccion5FormWrapperComponent } from 'src/app/shared/components/forms/seccion5-form-wrapper.component';
...
export class ResumenComponent implements OnInit, AfterViewInit {
  ...
  @ViewChild(Seccion4FormComponent) set seccion4Form(comp: Seccion4FormComponent) {
    ViewChildHelper.registerComponent('seccion4Form', comp);
  }
  @ViewChild(Seccion4ViewComponent) set seccion4(comp: Seccion4ViewComponent) {
    ViewChildHelper.registerComponent('seccion4', comp);
  }
  @ViewChild(Seccion4FormWrapperComponent) set seccion4FormWrapper(comp: Seccion4FormWrapperComponent) {
    ViewChildHelper.registerComponent('seccion4FormWrapper', comp);
  }
  @ViewChild(Seccion5FormComponent) set seccion5Form(comp: Seccion5FormComponent) {
    ViewChildHelper.registerComponent('seccion5Form', comp);
  }
  @ViewChild(Seccion5ViewComponent) set seccion5(comp: Seccion5ViewComponent) {
    ViewChildHelper.registerComponent('seccion5', comp);
  }
  @ViewChild(Seccion5FormWrapperComponent) set seccion5FormWrapper(comp: Seccion5FormWrapperComponent) {
    ViewChildHelper.registerComponent('seccion5FormWrapper', comp);
  }
  @ViewChild(Seccion6FormWrapperComponent) set seccion6(comp: Seccion6FormWrapperComponent) {
  ...
  @ViewChild(Seccion25ViewComponent) set seccion25(comp: Seccion25ViewComponent) {
    ViewChildHelper.registerComponent('seccion25', comp);
  }
  @ViewChild(Seccion26ViewComponent) set seccion26(comp: Seccion26ViewComponent) {
  ...
  @ViewChild(Seccion28ViewComponent) set seccion28(comp: Seccion28ViewComponent) {
    ViewChildHelper.registerComponent('seccion28', comp);
  }
  @ViewChild(Seccion28FormWrapperComponent) set seccion28FormWrapper(comp: Seccion28FormWrapperComponent) {
    ViewChildHelper.registerComponent('seccion28FormWrapper', comp);
  }
  @ViewChild(Seccion29ViewComponent) set seccion29(comp: Seccion29ViewComponent) {
    ViewChildHelper.registerComponent('seccion29', comp);
  }

  @ViewChild(Seccion29FormWrapperComponent) set seccion29Form(comp: Seccion29FormWrapperComponent) {
    ViewChildHelper.registerComponent('seccion29Form', comp);
  }
  @ViewChild(Seccion30ViewComponent) set seccion30(comp: Seccion30ViewComponent) {
    ViewChildHelper.registerComponent('seccion30', comp);
  }
  @ViewChild(Seccion30FormWrapperComponent) set seccion30Form(comp: Seccion30FormWrapperComponent) {
    ViewChildHelper.registerComponent('seccion30Form', comp);
  }
