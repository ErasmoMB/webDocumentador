...
export class Seccion16ViewComponent extends BaseSectionComponent implements OnDestroy {
  ...
  override readonly PHOTO_PREFIX = 'fotografiaReservorio';
  ...
  protected override onInitCustom(): void {
    ...
    this.fotografiasReservorio = this.getFotografiasVista('fotografiaReservorio');
    this.fotografiasUsoSuelos = this.getFotografiasVista('fotografiaUsoSuelos');
  }
