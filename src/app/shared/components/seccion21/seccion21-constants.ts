...
export const SECCION21_TEMPLATES = {
  ...
  parrafoAISIDefault: `En cuanto al área de influencia social indirecta (AISI), se ha determinado que esta se encuentra conformada por el CP {{centro}}, capital distrital de la jurisdicción homónima, en la provincia de {{provincia}}, en el departamento de {{departamento}}. Esta delimitación se debe a que esta localidad es el centro político de la jurisdicción donde se ubica el Proyecto, así como al hecho de que mantiene una interrelación continua con el área delimitada como AISD y que ha sido caracterizada previamente. Además de ello, es la localidad de donde se obtendrán bienes y servicios complementarios de forma esporádica, así como que se interactuará con sus respectivas autoridades políticas.`,

  parrafoCentroDefault: `El CP {{centro}} es la capital del distrito homónimo, perteneciente a la provincia de {{provincia}}, en el departamento de {{departamento}}. Su designación como capital distrital se oficializó mediante la Ley N°{{ley}}, promulgada el {{fecha}}, fecha en que se creó el distrito de {{distrito}}. Antes de ello, este asentamiento era un caserío del distrito de {{distritoAnterior}}, marcando un importante cambio en su desarrollo administrativo y social.`,
