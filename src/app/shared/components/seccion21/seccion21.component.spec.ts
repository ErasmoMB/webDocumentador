...
import { Seccion21Component } from './seccion21.component';
import { FormularioService } from 'src/app/core/services/formulario.service';

describe('Seccion21Component', () => {
  let component: Seccion21Component;
  let fixture: ComponentFixture<Seccion21Component>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [Seccion21Component],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(Seccion21Component);
