...
export const SECCION23_TEMPLATES = {
  ...
  petCompleteTemplateWithVariables: 'La población en edad de trabajar (PET) en el CP ____ representa un ____ de la población total y está soportada en su mayoría por el grupo etario de 45 a 64 años, puesto que son el ____ de la PET. El bloque de edad con menor cantidad de miembros es el de 65 años a más, puesto que representa solamente el ____ de la PET.',

  indicadoresDistritalesTemplateWithVariables: 'No obstante, los indicadores de la Población Económicamente Activa (PEA), tanto de su cantidad total como por subgrupos (Ocupada y Desocupada), se describen a nivel distrital siguiendo la información oficial de la publicación "Resultados Definitivos de la Población Económicamente Activa 2017" del INEI. Para ello es importante tomar en cuenta que la población distrital de ____, jurisdicción donde se ubica el AISD en cuestión, es de ____ personas, y que la PET (de 14 años a más) al mismo nivel está conformada por ____ personas.',

  peaCompleteTemplateWithVariables: 'La Población Económicamente Activa (PEA) constituye un indicador fundamental para comprender la dinámica económica y social de cualquier jurisdicción al nivel que se requiera. En este apartado, se presenta una descripción de la PEA del distrito de ____, jurisdicción que abarca a su capital distrital, el CP ____. Para ello, se emplea la fuente "Resultados Definitivos de la Población Económicamente Activa 2017" del INEI, con el cual se puede visualizar las características demográficas de la población en capacidad de trabajar en el distrito en cuestión.',

  peaAnalisisTemplateWithVariables: 'Del cuadro precedente, se aprecia que la PEA del distrito de ____ representa un ____ del total de la PET de la jurisdicción, mientras que la No PEA abarca el ____ restante. Asimismo, se visualiza que los hombres se hallan predominantemente dentro de la PEA, pues el ____ se halla en esta categoría. Por otro lado, la mayor parte de las mujeres se hallan en el indicador de No PEA con un ____.',

  empleoSituacionDefault: 'La mayor parte de la población de la capital distrital de ____ se dedica a actividades agropecuarias, siendo la agricultura y la ganadería las principales fuentes de empleo independiente. En el sector agrícola, los cultivos predominantes son la papa, cebada, habas, trigo y oca, productos que abastecen tanto el consumo local como el comercio en menor medida. Asimismo, la ganadería juega un papel importante, con la crianza de vacunos y ovinos como las principales actividades ganaderas de la zona. Aunque en menor proporción, algunos pobladores también se dedican al comercio, complementando así su ingreso económico.',
  ...
  ingresosTemplateWithVariables: 'Los ingresos de la población en la capital distrital de ____ están estrechamente relacionados con las actividades agropecuarias, las cuales constituyen la base económica de la localidad. S/. ____ mensuales, ocupando el puesto N°____ en el ranking de dicha variable.',

  indiceDesempleoTemplateWithVariables: 'El índice de desempleo es un indicador clave para evaluar la salud económica de una jurisdicción de cualquier nivel, ya que refleja la proporción de la Población Económicamente Activa (PEA) que se encuentra en busca de empleo, pero no logra obtenerlo. En este ítem, se caracteriza el índice de desempleo del distrito de ____, el cual abarca al CP ____ (capital distrital). Para ello se usa la tabla siguiente:',

  peaOcupadaDesocupadaTemplateWithVariables: 'Del cuadro precedente, se halla que en el distrito de ____ la PEA Desocupada representa un ____ del total de la PEA. En adición a ello, se aprecia que tanto hombres como mujeres se encuentran predominantemente en el indicador de PEA Ocupada, con porcentajes de ____ y ____, respectivamente.',

  // ===== TÍTULOS DE TABLA POR DEFECTO =====
  defaultPETTableTitle: 'PET según grupos de edad – CP ____ (2017)',
  defaultPeaDistritoSexoTableTitle: 'Conformación de la PEA y No PEA, según sexo – Distrito ____ (2017)',
  defaultPeaOcupadaDesocupadaTableTitle: 'Conformación de la PEA Ocupada y Desocupada, según sexo – Distrito ____ (2017)',
  ...
  // ===== FALLBACK DEFAULT PROPERTIES (Para compatibilidad con componente) =====
  centroPobladoDefault: 'Centro Poblado',
  peaAnalisisDefault: 'Del análisis de la Población Económicamente Activa en ____:',
  empleoSituacionDependiente: 'En cuanto al empleo dependiente, este sector es reducido y está conformado principalmente por trabajadores de instituciones públicas y educativas.',
  ingresosDefault: 'Los ingresos de la población están relacionados con las actividades económicas locales.',
  indiceDesempleoDefault: 'El índice de desempleo refleja la proporción de la Población Económicamente Activa que se encuentra en busca de empleo.',
};
