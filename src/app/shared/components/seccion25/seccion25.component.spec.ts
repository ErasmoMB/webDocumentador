...
import { Seccion25Component } from './seccion25.component';
import { FormularioService } from 'src/app/core/services/formulario.service';

describe('Seccion25Component', () => {
  let component: Seccion25Component;
  let fixture: ComponentFixture<Seccion25Component>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [Seccion25Component],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(Seccion25Component);
