...
import { Seccion27Component } from './seccion27.component';
import { FormularioService } from 'src/app/core/services/formulario.service';

describe('Seccion27Component', () => {
  let component: Seccion27Component;
  let fixture: ComponentFixture<Seccion27Component>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [Seccion27Component],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(Seccion27Component);
