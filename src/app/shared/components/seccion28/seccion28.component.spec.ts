...
import { Seccion28Component } from './seccion28.component';
import { FormularioService } from 'src/app/core/services/formulario.service';

describe('Seccion28Component', () => {
  let component: Seccion28Component;
  let fixture: ComponentFixture<Seccion28Component>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [Seccion28Component],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(Seccion28Component);
