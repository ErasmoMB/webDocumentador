...
import { Seccion30Component } from './seccion30.component';
import { FormularioService } from 'src/app/core/services/formulario.service';

describe('Seccion30Component', () => {
  let component: Seccion30Component;
  let fixture: ComponentFixture<Seccion30Component>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [Seccion30Component],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(Seccion30Component);
